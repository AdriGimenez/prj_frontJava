...
function mostrarResumen(){
  ...
  switch(categoria){
    case 'Estudiante':
      precio = cantidad * (200 - (200 * 0.80));
      break;
    case 'Trainee':
      precio = cantidad * (200 - (200 * 0.50));
      break;
    case 'Junior':
      precio = cantidad * (200 - (200 * 0.15));
  }
  
  document.getElementById("precioPagar").innerHTML = "Total a Pagar: $ "+ precio;
}
